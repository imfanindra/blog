...
description: My personal story of developing an interest in design and transitioning from B. Tech in Computer Science to M. Des in Interaction Design
date: July 21, 2024
---

import Link from "../../components/Link.vue";

![Institute of Design Block](/images/iod_block.jpg)
<small>Institute of Design - JKLU, Jaipur</small>
...
I started my B. Tech in Computer Science and Engineering with a specialization in Artificial Intelligence and Machine Learning at VIT, Bhopal. Then COVID hit, and our classes moved online for almost two years. Once we returned to campus, I began to question my choices. DSA and problem-solving weren’t my strengths; I only enjoyed front-end development and completed a few projects in that area.
...
- **Juxtopposed** - <Link href="https://www.youtube.com/@juxtopposed" external>youtube.com/@juxtopposed</Link> 
- **Figma** - <Link href="https://www.youtube.com/@Figma" external>youtube.com/@Figma</Link> 
- **Rachel How** - <Link href="https://www.youtube.com/@rachelhow" external>youtube.com/@rachelhow</Link> 
- **Ansh Mehra** - <Link href="https://www.youtube.com/@AnshMehraa" external>youtube.com/@AnshMehraa</Link> 
- **Aliena Cai** - <Link href="https://www.youtube.com/@AlienaCai" external>youtube.com/@AlienaCai</Link>
- **Framer University** - <Link href="https://www.youtube.com/@framer.university" external>youtube.com/@framer.university</Link> 
- **Huy NG** - <Link href="https://www.youtube.com/@huyngxyz" external>youtube.com/@huyngxyz</Link> 
...
Taking my parents' advice, I decided to pursue a Master's in Design. I researched colleges offering M. Des in Interaction Design, UX Design, and HCI. Studying abroad was never an option, so I focused on India. I learned about CEED, an entrance exam for IITs and other design colleges, but my under-par drawing and sketching skills meant I didn't score well.

I applied to several colleges, including IDC IIT Bombay, IIT Hyderabad, IIT Delhi, DTU, IIT Jodhpur, JKLU, and WUD. I was shortlisted for interviews at JKLU, WUD, and IIT Jodhpur (Self-sponsored seat) and received acceptance letters from JKLU and WUD. Based on my interview experiences, I preferred JKLU to do my M. Des
